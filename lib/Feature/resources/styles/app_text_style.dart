...
// default
  ...
  ///gray
  static TextStyle textStyleRegularGray = TextStyle(
  ...
  static const TextStyle textStyleMediumGray18 = TextStyle(
...
// gray
  ...
  static const TextStyle textStyleBoldBlackW400 = TextStyle(
    color: Color.fromRGBO(0, 0, 0, 1),
    fontSize: 15,
    fontWeight: FontWeight.w500,
  );
  ...
  static const TextStyle textStyleBoldBlack25 = TextStyle(
    color: Color.fromRGBO(0, 0, 0, 1),
    fontSize: 28,
    fontWeight: FontWeight.w700,
  );
